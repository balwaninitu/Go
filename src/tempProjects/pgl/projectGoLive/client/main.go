...
//const baseURL = "https://localhost:5000/api/v1/seller"
...
func client_console() {
	...
	for {
		...
		fmt.Println("8. Add An item for a seller")
		fmt.Println("9. Update An item for a seller")
		fmt.Println("10. Delete An item for a seller")
		fmt.Println("11. Exit")
		fmt.Scanln(&choice)
		switch choice {
		case 1:
