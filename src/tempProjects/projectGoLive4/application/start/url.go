...
func mapUrls() {
	...
	//router.HandleFunc("/admin/viewuser", user_db.GetRecords)
	router.HandleFunc("/admin/viewseller", admin.ViewSeller)
	router.HandleFunc("/admin/viewbuyer", seller.SellerHandler)
