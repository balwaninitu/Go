...
func BuyerHandler(w http.ResponseWriter, req *http.Request) {
	...
	//buyerToTemplate.Mainmessage = append(buyerToTemplate.Mainmessage, "Welcome to Peel Rescue! ")
...
func ShowProfile(w http.ResponseWriter, req *http.Request) {
	...
	buyerToTemplate.Mainmessage = append(buyerToTemplate.Mainmessage, "Here are your profile details :")
